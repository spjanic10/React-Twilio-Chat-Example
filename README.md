Part of a final project in Software Engineering. Built a small React app from a Twilio sample. This app is used to interface with the Twilio Conversations API.
